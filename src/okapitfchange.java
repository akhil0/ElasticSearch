...
public class okapitfchange {
	...
	public static void main(String[] args) throws IOException, JSONException {
		...
		while(queritr.hasNext())
		{
			...
			{
				String qb = words[i];
				resultmap =  queryTF(client, qb, "ap_dataset" , "document", resultmap, lengthmap,queryno, mainstr);
			}
	...
	private static void printmap(HashMap<String, Double> resultmap, String string) {
		...
		File log = new File("C:\\Users\\AKI\\workspace\\Elasticsearch\\okapitfchange.txt");
	...
	//Query based on term
	public static HashMap<String, Double> queryTF(Client client, String qb, String index, String type, HashMap<String, Double> result,HashMap<String, Double> lengthmap, String queryno, String mainstr) throws IOException, JSONException {
		...
		for(int i=0 ; i < hits.length() ; i ++)
		{
			...
			double okapitf = tf/(tf + 0.5 + 1.5*(len/247.8));
